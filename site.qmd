...
::: {.callout-tip icon=false collapse="true" title="`Sort_Columns()`"}
```{r}
#| output: true
#| code-fold: true
...
::: {.callout-tip icon=false collapse="true" title="`Dataframe_To_Graph()`"}
```{r}
#| output: true
#| code-fold: true
#| code-summary: "Click for more details."
...
This metric examines the distribution of the number of connections (degrees) of nodes in the graph. It provides insights into the connectivity patterns within the graph.

::: {.callout-tip icon=false collapse="true" title="R functions"}
```{r}
#| code-overflow: scroll

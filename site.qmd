...
Now, the networks which has been to be compared must be imported. 
...
Now, we just have the genes that are in a relation of regulation. 
...
```{r}
GlobalIdentity_Length_Comparison(DIANE, TDCor,  3)
```
